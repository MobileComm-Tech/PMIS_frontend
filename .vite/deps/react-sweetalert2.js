...
var withSwal = function(Component) {
  return import_react.default.forwardRef(function(props, ref) {
    return import_react.default.createElement(Component, __assign({ ref, swal: Swal }, props));
  });
};
function SweetAlert2(props) {
  ...
  (0, import_react.useEffect)(function() {
    var swalContainer2 = Swal.getHtmlContainer();
    if (swalContainer2) {
  ...
  function mountSwal() {
    ...
    Swal.fire(rest).then(function(result) {
      if (result.isConfirmed)
        onConfirm && onConfirm(result);
      onResolve && onResolve(result);
    }).catch(function(error2) {
      return onError && onError(error2);
    });
  }

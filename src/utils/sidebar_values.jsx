...
export const Sidebar_content = {
  ...
  GlobalUrl: [
    ...
    {
      name: "",
      link: "/projectManagement_1/:cname/:customeruniqueId",
      subMenu: [],
      component: <ManageProject />,
    },
    // {
    ...
    {
      name: "",
      link: "/projectManagement_2/:cname/:customeruniqueId/:proId/:projectuniqueId",
      subMenu: [],
      component: <ManageProjectSiteId />,
    },
    {
    ...
    },
    {
      ...
      link: "/hr/superAdmin/manageCustomer",
      subMenu: [],
      component: <ManageCustomer />,
    ...
    {
      name: "Manage Circle",
      link: "/hr/superAdmin/manageRegion",
      subMenu: [],
    ...
    {
      name: "Manage Zone",
      link: "/hr/superAdmin/manageState",
      subMenu: [],
    ...
    {
      name: "",
      link: "/hr/superAdmin/manageRateWithActivity",

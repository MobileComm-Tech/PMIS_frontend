...
// console.log(itm?.changeTo,"___itm?.changeTo__")


//   return (
//     <div className="px-2 ">
//       <label className="text-white ">{label}</label>
//       {selectedOption === itm?.changeTo!==undefined?itm?.changeTo:"text" ? (
//         <div className={`flex flex-col h-full w-full ${itm?.visible==false? 'hidden':''}`}>
//           <input
//             type={itm?.changeTo!==undefined?itm?.changeTo:"text"}
//             min="1"
//             name={itm?.name}
//             max="50000"
//             placeholder="Enter Quantity"
...
//             </option>
//           ))}
//           <option value={itm?.changeTo!==undefined?itm?.changeTo:"text"}>Select your Own Number</option>
//         </select>
//       )}
//     </div>
//   );

  ...
  reducers: {
    ...
    GET_GRAPH_ZONE_IN_CIRCLE_REVENUE: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphZoneInCirlceRevenue = [
          ...state.getGraphZoneInCirlceRevenue,
          ...payload.dataAll,
        ];
      }
    ...
    GET_TOTAL_ACTIVE_CUSTOMER: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphTotalActiveCustomer = [
          ...state.getGraphTotalActiveCustomer,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_MS1_AND_MS2_CIRCLEWISE: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphMS1AndMS2CircleWise = [
          ...state.getGraphMS1AndMS2CircleWise,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_ORG_LEVEL: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphOrganizationLevel = [
          ...state.getGraphOrganizationLevel,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_PO_Tracking_WorkDone: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphPoTrackingWorkdone = [
          ...state.getGraphPoTrackingWorkdone,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_ACCRUAL_REVENUE_TREND: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphAccrualRevenueTrend = [
          ...state.getGraphAccrualRevenueTrend,
          ...payload.dataAll,
        ];
      }
    ...
    GET_MONTHLY_JOINING_AND_RESIGN_DATE: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getmonthJoiningandresign = [
          ...state.getmonthJoiningandresign,
          ...payload.dataAll,
        ];
      }
    ...
    GET_AIRTEL_ACTIVE_EMP_VERTICAL_NAME: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getAirtelActiveEmpVerticalName = [
          ...state.getAirtelActiveEmpVerticalName,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_NEW_JOINING_MONTHLY: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphNewJoiningMonthly = [
          ...state.getGraphNewJoiningMonthly,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_MONTHLY_JOINING_VS_EXIT: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphMonthlyJoiningVsExit = [
          ...state.getGraphMonthlyJoiningVsExit,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_MONTHLY_ACTIVE_TREND: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphMonthlyActiveTrend = [
          ...state.getGraphMonthlyActiveTrend,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_VENDOR_ACTIVE_INACTIVE: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphVendorActiveInactive = [
          ...state.getGraphVendorActiveInactive,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_REVENUE_PLAN_VS_ACTUAL: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphRevenuePlanVSActual_Trend = [
          ...state.getGraphRevenuePlanVSActual_Trend,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_REVENUE_PLAN_VS_ACTUAL_Circle: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphRevenuePlanVSActual_Circle = [
          ...state.getGraphRevenuePlanVSActual_Circle,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_TREND_EXPENSE_ADVANCE: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphTrendExpenseAdvance = [
          ...state.getGraphTrendExpenseAdvance,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_EXPENSE_APPROVAL_STATUS: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphExpenseApprovalStatus = [
          ...state.getGraphExpenseApprovalStatus,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_ADVANCE_APPROVAL_STATUS: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphAdvanceApprovalStatus = [
          ...state.getGraphAdvanceApprovalStatus,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_TREND_PLAN_VS_ACTUAL_WORKDONE: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphTrendPlanVSActualWorkdone = [
          ...state.getGraphTrendPlanVSActualWorkdone,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_Circle_PLAN_VS_ACTUAL_WORKDONE: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphCirclePlanVSActualWorkdone = [
          ...state.getGraphCirclePlanVSActualWorkdone,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_CUMULATIVE_TREND_PLAN_VS_ACTUAL: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphCumulativeTrendPlanVsActual = [
          ...state.getGraphCumulativeTrendPlanVsActual,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_CUMULATIVE_WORKDONE_PLAN_VS_ACTUAL: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphCumulativeWorkdonePlanVsActual = [
          ...state.getGraphCumulativeWorkdonePlanVsActual,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_MS2_VS_WCC_PENDING_REASON: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getGraphMS2vsWCCPendingReason = [
          ...state.getGraphMS2vsWCCPendingReason,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_PROJECT_TYPE_UNBILLED: (state, { payload }) => {
      if (payload.reset) {
        ...
        state.getProjectTypeUnbilledGraph = [
          ...state.getProjectTypeUnbilledGraph,
          ...payload.dataAll,
        ];
      }
    ...
    GET_GRAPH_UNBILLED: (state, { payload }) => {
      if (payload.reset) {
        state.getGraphUnbilled = payload.dataAll;
      } else {
        state.getGraphUnbilled = [
          ...state.getGraphUnbilled,
          ...payload.dataAll,
        ];
      }

...
const vendorData = createSlice({
    ...
    reducers: {
        ...
        GET_VENDOR_COST_MILESTONE_SECOND: (state, { payload }) => {
            if (payload.reset) {
                state.getVendorCostMilestoneSecond = payload.dataAll
            } else {
                state.getVendorCostMilestoneSecond = [...state.getVendorCostMilestoneSecond, ...payload.dataAll]
            }
        },
        GET_VENDOR_COST_MILESTONE_LIST: (state, { payload }) => {
            if (payload.reset) {

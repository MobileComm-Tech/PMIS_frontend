...
import {
  GET_PROJECT_ALL_LIST,
  GET_PROJECT_TYPE_SUB,
  GET_USER_ALLLOCATED_PROJECT,
  GET_PROJECT_CIRCLE,
  SET_DYNAMIC_FORM,
  GET_MAPPED_DATA,
  GET_CIRCLE_WITH_PG_DATA,
  GET_USR_NOTIFICATION,
  GET_GLOBAL_COMPLAINCE_TYPE_DATA,
...
const projectListActions = {
  ...
  VendorList:
    ...
    async (dispatch, _) => {
      try {
        const res = await Api.post({ url: Urls.AssignVendorList, data: data });
        ...
        console.log(error, "assign vendor error");
        let msgdata = {
          show: true,
          icon: "error",
          buttons: [],
          type: 1,
          text: "Failed to assign vendor. Please try again.",
        };
        dispatch(ALERTS(msgdata));
      }
    },
  getProjectType:
    (uniqueId, reset = true, show = 1) =>
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.admin_getProjectSubType}/${uniqueId}`,
          show: show,
        });
        if (res?.status !== 200) return;
  ...
  getMappedData:
    ...
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.admin_getMappedData}/${uniqueId}`,
          show: show,
        });
        if (res?.status !== 200) return;
  ...
  getCircleWithPGData:
    ...
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.admin_getCircleWithPG}/${uniqueId}`,
          show: show,
        });
        if (res?.status !== 200) return;
        let dataAll = res?.data?.data;
  ...
  getProjectTypeAll:
    (uniqueId, args = "", reset = true) =>
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.projectList_siteEngineer}/${uniqueId}${
            args != "" ? "?" + args : ""
          }`,
        });
        if (res?.status !== 200) return;
      ...
      const res = await Api.post({
        ...
        url:
          uniqueId == null
            ...
            : Urls.projectList_siteEngineer + "/" + uniqueId,
      });
      if (res?.status !== 201 && res?.status !== 200) {
        let msgdata = {
          show: true,
  ...
  submitProjectTypeData:
    (urle, data, cb = () => {}, reset = true) =>
    async (dispatch, _) => {
      try {
  ...
  globalProjectTypeDataPatch:
    (urle, projectuniqueId, data, cb = () => {}, reset = true) =>
    async (dispatch, _) => {
      try {
        if (projectuniqueId != null) {
          data["projectuniqueId"] = projectuniqueId;
        }
        const res = await Api.patch({
          url: urle + "/" + projectuniqueId,
          data: data,
        });
        if (res?.status !== 200 && res?.status !== 201) {
          let msgdata = {
  ...
  globalComplianceTypeDataPatch:
    ...
    async (dispatch, _) => {
      try {
        ...
        console.log(
          error,
          "globalComplianceTypeApproverDataamit errorerror 37"
        );
      }
    },

  globalComplianceTypeDataGet:
    (sietId, mileStoneId, args = "", reset = true, cb = () => {}) =>
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.compliance_globalSaver}/${sietId}/${mileStoneId}${
            args != "" ? "?" + args : ""
          }`,
        });
        if (res?.status !== 200) return;
  ...
  globalComplianceTypeApproverDataGet:
    (id, args = "", reset = true, cb = () => {}) =>
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.compliance_globalSaver_Approver}/${id}${
            args != "" ? "?" + args : ""
          }`,
        });
        if (res?.status !== 200) return;
  ...
  globalComplianceTypeApproverDataPost:
    (id, data, cb = () => {}, reset = true) =>
    async (dispatch, _) => {
      try {
        const res = await Api.post({
          url: `${Urls.compliance_globalSaver_Approver}/${id}`,
  ...
  globalComplianceTypeApproverDataPatch:
    (urle, id, data, cb = () => {}, reset = true) =>
    async (dispatch, _) => {
      try {
  ...
  getUserAllocatedProject:
    ...
    async (dispatch, _) => {
      try {
        ...
        const res = await Api.get({
          url: `${Urls.projectList_getproject_allocation}${uid}${
            args != "" ? "?" + args : ""
          }`,
          reset,
        });
  ...
  getProjectCircle:
    ...
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.project_circle}${args != "" ? "?" + args : ""}`,
          reset,
        });
        if (res?.status !== 200) return;
        let dataAll = res?.data?.data;
  ...
  getnotification:
    ...
    async (dispatch, _) => {
      try {
        const res = await Api.get({
          url: `${Urls.user_notification}${args != "" ? "?" + args : ""}`,
          reset,
        });
        if (res?.status !== 200) return;
        let dataAll = res?.data?.data;

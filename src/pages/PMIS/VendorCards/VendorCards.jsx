    ...
    <>
      <div className="absolute w-full top-12 mt-12 h-16 z-10 bg-[#3e454d] overflow-auto ">
        <CCDash
          showbtn={false}
          approveddata={[
            ['Partner On-Board', 'bg-pcol', '/vendor/managePartner'],
            ['Partner Team', 'bg-pcol', '/vendor/partnerTeam'],
            ['Project Tracking', 'bg-pcol', '/vendor/projectTracking'],
            ['Partner WCC', 'bg-pcol', '/vendor/WCC'],
            ...
            //   "/vendor/vendorCost",
            // ],
            ['Commercial', 'bg-pcol', '/vendor/commercial'],
          ].map((itm) => {
            return (
              <>

...
const EMF = () => {
  ...
  const onTableViewSubmit = (data) => {
    data['fileType'] = 'emfUpload';
    dispatch(
      CommonActions.fileSubmit(Urls.common_file_uploadr, data, () => {
        dispatch(FormssActions.getWccEmf());
        setFileOpen(false);
        resetting('');
      }),
    );
  ...
  useEffect(() => {
    ...
    dispatch(FormssActions.getWccEmf(true, defaultPagination));
  }, []);

  const tableData = useSelector((state) => state?.formssData?.getWccEmf);
  //   Table Data Ends here

  let dbConfigTotalCount = useSelector((state) => {
    let interdata = state?.formssData?.getWccEmf;
  ...
  return (
    <>
      <AdvancedTable
        headerButton={
          <div className="flex">
            ...
            /> */}
            <ConditionalButton
              showType={getAccessType(wccAccessInFormsKey?.EMF?.upload)}
              name={'Upload File'}
              classes="w-auto mr-1"
              onClick={() => setFileOpen(true)}
            />
            <ConditionalButton
              showType={getAccessType(wccAccessInFormsKey?.EMF?.export)}
              name={'Export'}
              classes="w-auto mr-1"
              onClick={() =>
                dispatch(
      ...
      <FileUploader
        ...
        tempbtn={true}
        tempbtnlink={['/template/emfUpload.xlsx', 'EMF_File_template.xlsx']}
...
//         tempbtn={true}
//         tempbtnlink={[
//           "/template/emfUpload.xlsx",
//           "EMF_File_template.xlsx",
//         ]}
//         head={"Upload Upgrade File"}
//       />
//     </>

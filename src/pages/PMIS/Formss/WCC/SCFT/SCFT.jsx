...
const SCFT = () => {
  ...
  const onTableViewSubmit = (data) => {
    data['fileType'] = 'scftUpload';
    dispatch(
      CommonActions.fileSubmit(Urls.common_file_uploadr, data, () => {
        dispatch(FormssActions.getWccScft());
        setFileOpen(false);
        resetting('');
      }),
    );
  ...
  useEffect(() => {
    ...
    dispatch(FormssActions.getWccScft(true, defaultPagination));
  }, []);

  const tableData = useSelector((state) => state?.formssData?.getWccScft);
  // console.log(tableData,"___sdvbajsd")
  //   Table Data Ends here

  let dbConfigTotalCount = useSelector((state) => {
    let interdata = state?.formssData?.getWccScft;
  ...
  return (
    <>
      ...
      <FileUploader
        ...
        tempbtn={true}
        tempbtnlink={['/template/scftUpload.xlsx', 'SCFT_File_template.xlsx']}
...
//         tempbtn={true}
//         tempbtnlink={[
//           "/template/scftUpload.xlsx",
//           "SCFT_File_template.xlsx",
//         ]}
//         head={"Upload Upgrade File"}
//       />
//     </>

...
const OCI = () => {
  ...
  let dbConfigTotalCount = useSelector((state) => {
    let interdata = state?.formssData?.getWccOci;
  ...
  return (
    <>
      <AdvancedTable
        headerButton={
          <div className="flex">
            ...
            /> */}
            <ConditionalButton
              showType={getAccessType(wccAccessInFormsKey?.OCI?.upload)}
              name={'Upload File'}
              classes="w-auto mr-1"
              onClick={() => setFileOpen(true)}
            />
            <ConditionalButton
              showType={getAccessType(wccAccessInFormsKey?.OCI?.export)}
              name={'Export'}
              classes="w-auto mr-1"
              onClick={() =>
                dispatch(
      ...
      <FileUploader
        ...
        tempbtn={true}
        tempbtnlink={['/template/ociUpload.xlsx', 'OCI_File_template.xlsx']}
...
//         tempbtn={true}
//         tempbtnlink={[
//           "/template/ociUpload.xlsx",
//           "OCI_File_template.xlsx",
//         ]}
//         head={"Upload Upgrade File"}
//       />
//     </>

...
const PAT = () => {
  ...
  let dbConfigTotalCount = useSelector((state) => {
    let interdata = state?.formssData?.getWccPat;
  ...
  return (
    <>
      <AdvancedTable
        headerButton={
          <div className="flex">
            ...
            /> */}
            <ConditionalButton
              showType={getAccessType(wccAccessInFormsKey?.PAT?.upload)}
              name={'Upload File'}
              classes="w-auto mr-1"
              onClick={() => setFileOpen(true)}
            />
            <ConditionalButton
              showType={getAccessType(wccAccessInFormsKey?.PAT?.export)}
              name={'Export'}
              classes="w-auto mr-1"
              onClick={() =>
                dispatch(
      ...
      <FileUploader
        ...
        tempbtn={true}
        tempbtnlink={['/template/patUpload.xlsx', 'PAT_File_template.xlsx']}
...
//         tempbtn={true}
//         tempbtnlink={[
//           "/template/patUpload.xlsx",
//           "PAT_File_template.xlsx",
//         ]}
//         head={"Upload Upgrade File"}
//       />
//     </>

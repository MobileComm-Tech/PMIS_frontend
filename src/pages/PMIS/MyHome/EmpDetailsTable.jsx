            ...
            child={
              <EditButton
                ...
                onClick={() => {
                  ...
                  dispatch(
                    GET_MANAGE_DESIGNATION({ dataAll: [], reset: true }),
                  );
                  dispatch(
                    GET_MANAGE_COST_CENTER({ dataAll: [], reset: true }),
                  );
                  dispatch(
                    AdminActions.getCities(true, `stateCode=${itm?.state}`),
                  );
                  if (itm.customer) {
                    dispatch(
                      AdminActions.getManageDepartment(true, '', itm.customer),
                    );
                    dispatch(
                      AdminActions.getManageDesignation(true, '', itm.customer),
                    );
                    dispatch(
                      AdminActions.getManageCostCenter(true, '', itm.customer),
                    );
                  }
  ...
  return (
    <>
      <AdvancedTable
        ...
        table={table}
        exportButton={[
          '/export/manageEmployee' + '?' + strVal,
          'Export_Employee(' + dt + ').xlsx',
        ]}

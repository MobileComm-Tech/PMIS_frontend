...
// //     //       dispatch(
// //     //         ExpenseAdvanceActions.getPtwData(
// //     //           // true,
// //     //           // `siteId=${e.target.value}`
// //     //           `siteId=${selectedOption}&projectId=${e.target.value}&milestoneId=${e.target.value}`
...
// //           dispatch(
// //             ExpenseAdvanceActions.getPtwData(
// //               `siteId=${selectedSiteId}&projectId=${selectedOption}&milestoneId=${selectedOption}`
// //             )
// //           );
// //         },
// //       },
...
// //     // Assuming you're using React and managing form state with a `formValue` object.
...
// //     //         ExpenseAdvanceActions.getPtwData(
// //     //           `siteId=${selectedValue}&projectId=${selectedValue}&milestoneId=${selectedValue}`
// //     //         )
// //     //       );

// //     //       const ptwNumber = response?.data?.ptwNumber;
...
// //       setCategory(
// //         claimTypeList.filter((itm) => itm.label == formValue["types"])[0]
// //           ?.categories || [""]
// //       );
...
// //       setValue(
// //         "claimType",
// //         claimTypeList.filter((itm) => itm.label == formValue["claimType"])[0]?.[
// //           "value"
// //         ]
// //       ) || [];
...
//   const [selectedProjectId2, setSelectedProjectId2] = useState("");
//   const [selectedMilestoneId, setSelectedMilestoneId] = useState("");

//   let dispatch = useDispatch();

//   const ptwData = useSelector((state) => {
//     return state?.expenseAdvanceData?.getPtwData;
//   });
...
//       const ptwNumber = Array.isArray(ptwData) 
//         ? ptwData[0]?.ptwNumber || ptwData[0]?.PTWNumber || ""
//         : ptwData?.ptwNumber || ptwData?.PTWNumber || "";
      
//       setValue("ptwNumber", ptwNumber);
//     }
//   }, [ptwData, setValue]);
...
//           setSelectedProjectId2(projectId);
//           dispatch(
//             ExpenseAdvanceActions.getExpADvSiteID(
//               true,
//               `projectId=${projectId}`
...
//           setSelectedMilestoneId(taskId);
          
       
//           setValue("ptwNumber", "");
          
//           if (selectedSiteId && selectedProjectId2) {
//             dispatch(
//               ExpenseAdvanceActions.getPtwData(
//                 `siteId=${selectedSiteId}&projectId=${selectedProjectId2}&milestoneId=${taskId}`
//               )
//             );
//           }
//         },
...
//       data.expenseId = expenseRef.current?.ExpenseNo;
//     }
//     dispatch(ExpenseAdvanceActions.postFillExpense(true, data, onSuccess));
//   }
// };

    ...
    <div className="">
      <AdvancedTable
        ...
        data={allData?.map((item) => {
          console.log(item?.message, "messageuusu");
          return {
            ...item,
            message: item?.message ? (
              item?.message.split("/").includes("uploads") ? (
                <p
                  className="underline-offset-1 underline text-blue-500 cursor-pointer "
                  onClick={() => {
      ...
      <Modal
        ...
        children={
          <img
            ...
            className="w-full h-[90vh] object-fill  rounded-md"
            alt=""
          />
        }
        isOpen={image}

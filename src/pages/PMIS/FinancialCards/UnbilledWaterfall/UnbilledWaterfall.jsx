...
const Unbilled = () => {
    ...
    useEffect(() => {
        ...
        dispatch(
            CommonActions.fileSubmit(Urls.common_file_uploadr+"/"+customerId, data, () => {
                dispatch(FinanceActions.getUnbilled(true,"","",customerId));
                setFileOpen(false);
                resetting("");
            })
        ...
        <AdvancedTable
            ...
            headerButton={
                ...
                <ConditionalButton
                    ...
                    classes="w-auto mr-1"
                    onClick={() => {
                        dispatch(CommonActions.commondownload(`/export/Unbilled/${customerId}` + "?" + strValFil,`Export_${customer}_Unbilled.xlsx`))
                    }}
                ></ConditionalButton>
                </>
            }

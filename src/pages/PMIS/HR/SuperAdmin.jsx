    ...
    <div className="absolute w-full top-12 mt-12 h-16 sm:h-16 md:h-32 xl:h-1/2 z-10 bg-[#3e454d] overflow-auto">
      <CCDash
        ...
        approveddata={[
          ...
          //   "Manage Customer",
          //   "bg-pcol",
          //   "/hr/superAdmin/manageCustomer",
          //   "border-b-[#fdf0d5]",
          // ],
          [
            "Manage Region",
            "bg-pcol",
            "/hr/superAdmin/manageRegion",
            "border-b-[#fdf0d5]",
          ],
          [
            "Manage State",
            "bg-pcol",
            "/hr/superAdmin/manageState",
            "border-b-[#fdf0d5]",
          ],
          [
            "Manage Market",
            "bg-pcol",
            "/hr/superAdmin/manageMarket",
            "border-b-[#e2eafc]",
          ],
          [
            "Manage Profiles",
          ...
          //   "bg-pcol",
          //   "/hr/superAdmin/manageRateWithActivity",
          //   "border-b-[#b8e0d2]",
          // ],
          // [
          //   "Activity Logs",

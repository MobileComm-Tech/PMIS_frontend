...
const VendorActivity2 = () => {
    ...
    let dbConfigList = useSelector((state) => {
        let interdata = state?.adminData?.getPartnerActivitySecond || [""]
                    ...
                    let msgdata = {
                        ...
                        buttons: [
                            <Button classes='w-15 bg-rose-400' onClick={() => {
                                dispatch(CommonActions.deleteApiCaller(`${Urls.admin_partner_activity_second}/${itm.uniqueId}`, () => {
    ...
    const onSubmit = (data) => {
        ...
        delete data.reseter
        dispatch(AdminActions.getPartnerActivitySecond(value, objectToQueryString(data)))
    }
                ...
                <div className='flex gap-1'>
                    ...
                    <Button 
                        ...
                        onClick={(e) => {
                            ...
                            dispatch(CommonActions.commondownload("/export/partnerActivity2","Export_Partner_Activity.xlsx"))
                        }}>
                    </Button>
                </div>
            }
...
export default VendorActivity2;
...
const ManageProjectSiteId = () => {
  ...
  let table = {
    columns: [
      ...
      {
        name: "Local Grid Cell Index",
        value: "LocalGridCellIndex",
        style: "min-w-[140px] max-w-[200px] text-center",
      },
      // {
      //   name: "Completion (%)",
  ...
  const onTableViewSubmit = (data) => {
    ...
    let makeurl = `${Urls.common_file_uploadr}${
      "/" + projectuniqueId
    }`;
    dispatch(

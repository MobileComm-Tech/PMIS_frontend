...
const ManageUserProjectAllocation = () => {
  ...
  const onSubmit = (data) => {
    ...
    setstrVal(strVal);
    dispatch(
      AdminActions.getProjectAllocation(
        value,
  ...
  return (
    <>
              ...
              onClick={(e) => {
                dispatch(
                  CommonActions.commondownload(
                    '/export/userProjectAllocation' + '?' + strValFil,
                    'Export_User_Project_Allocation.xlsx',
                  ),
                );
              }}
            ></Button>
      ...
      <FileUploader
        ...
        tempbtn={true}
        tempbtnlink={[
          '/template/UserProjectAllocation.xlsx',
          'UserProjectAllocation.xlsx',
        ]}
      />
    </>
  );

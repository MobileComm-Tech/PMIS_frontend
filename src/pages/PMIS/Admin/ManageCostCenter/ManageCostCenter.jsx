                        ...
                        onClick={() => {
                          dispatch(
                            CommonActions.deleteApiCaller(
                              `${Urls.admin_cost_center}/${itm.uniqueId}`,
                              () => {
                                dispatch(AdminActions.getManageCostCenter());
  ...
  return (
    <>
              ...
              onClick={(e) => {
                dispatch(
                  CommonActions.commondownload(
                    "/export/manageCostCenter",
                    "Export_Cost_Center.xlsx"
                  )
                );
              }}
            ></Button> */}
      ...
      <FileUploader
        ...
        tempbtn={true}
        tempbtnlink={["/template/CostCenter.xlsx", "CostCenter.xlsx"]}
      />
    </>
  );
};

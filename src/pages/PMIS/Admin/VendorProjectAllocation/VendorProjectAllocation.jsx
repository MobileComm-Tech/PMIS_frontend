...
const VendorProjectAllocation = () => {
  ...
  const onSubmit = (data) => {
    ...
    dispatch(
      AdminActions.getVendorProjectAllocation(
        value,
  ...
  return (
    <>
              ...
              onClick={(e) => {
                dispatch(
                  CommonActions.commondownload(
                    '/export/partnerProjectAllocation' + '?' + strValFil,
                    'Export_Partner_Project_Allocation.xlsx',
                  ),
                );
              }}
            ></Button>
      ...
      <FileUploader
        ...
        tempbtn={true}
        tempbtnlink={[
          '/template/PartnerProjectAllocation.xlsx',
          'PartnerProjectAllocation.xlsx',
        ]}
      />
    </>
  );

  ...
  return checkauth ? (
    ...
    <>
      <WithSideImage
        ...
        formclass={" h-auto"}
        labeling={"Login to your account"}
        form={
            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  <label
                    htmlFor="email"
                    className="block text-sm text-[#13b497]  pl-4 font-extrabold leading-6 font-poppins  dark:text-darkBg"
                  >
                    Email
                  </label>
                </div>
                <div className="mt-2 flex">
                  <input
                    ...
                    className="p-2 block w-full border-b-2 py-1.5 text-black-900 sm:text-sm sm:leading-6 bg-[#b5efe6] rounded-md  text-black font-poppins outline-none border-gray-400 focus:border-blue-500 shadow-lg focus:shadow-indigo-500/30  rounded-4"
                ...
                <p className="text-xs text-rose-500 font-extrabold mt-1">
              ...
              <div>
                <div className="flex items-center justify-between">
                  <label
                    htmlFor="password"
                    className="block text-sm pl-4 font-extrabold leading-6 text-[#13b497] font-poppins dark:text-darkBg"
                  >
                    Password
                  </label>
                </div>
                <div className="mt-2 flex">
                  <input
                    ...
                    className="p-2 block w-full border-b-2  py-1.5 text-black-900 sm:text-sm sm:leading-6 rounded-md bg-[#b5efe6] text-black font-poppins outline-none border-gray-400 focus:border-blue-500 shadow-lg focus:shadow-indigo-500/30"
                    placeholder="•••••••••••"
                  />
                  <div
                    className="relative right-7 top-[10px] cursor-pointer text-[#0a2b25]"
                    onClick={toggleEye}
                  >
                    {!showPassword ? (
                      <>
              ...
              <div className="flex items-center justify-between space-x-3 mr-4">
                ...
                <p className="text-center text-[#dbbf96] text-[13px] font-bold">
                  Or
                </p>
                <hr className="flex-grow border-t border-[#13b497]" />
              </div>
              <div className="flex justify-center">
                <button
                  className="btn text-[#cbaf87] text-sm font-semibold float-right mr-2 hover:underline hover:font-extrabold"
                  onClick={() => {
                ...
                <button
                  className="btn text-[#13b497] text-sm font-semibold float-right mr-5 hover:underline hover:font-extrabold"
                  onClick={() => {
                    navigate("/register");
                  }}
                >
